...
This directory houses shared knowledge for the template project. Start here to find architecture notes, API contracts, operational runbooks, and reusable templates.

## Index
- [Codex Development Guide](codex-development.md)
